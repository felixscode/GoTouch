...
| Provider | Cost/hour | Speed | Setup |
|----------|-----------|-------|-------|
| **Anthropic Claude** | ~$0.02-0.05 | <1s | API key required |
| **OpenAI GPT** | ~$0.01-0.60 | <2s | API key required |
| **Ollama (Local)** | Free | 2-10s | Local install, no key |
